...
class ChildrenFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_children_schools1_idx' => ['type' => 'index', 'columns' => ['school_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_children_schools1' => ['type' => 'foreign', 'columns' => ['school_id'], 'references' => ['schools', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'school_id' => 1,
            'order' => 1,
            'created' => '2015-12-04 16:36:06',
            'modified' => '2015-12-04 16:36:06'
        ],
    ];
}
